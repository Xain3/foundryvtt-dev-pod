...
# This script provides Windows compatibility for the use-cache-or-stagger patch.
...
function Get-WrapperMetadata {
  ...
  # Parse filename like "00-use-cache-or-stagger.ps1" -> procedural: "00", patch: "use-cache-or-stagger"
...
Examples:
  .\00-use-cache-or-stagger.ps1
  .\00-use-cache-or-stagger.ps1 --dry-run
  .\00-use-cache-or-stagger.ps1 --wrapper-target custom-script
"@
}
